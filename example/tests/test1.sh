...
( time galba.pl --genome=../genome.fa --prot_seq=../proteins.fa --skipOptimize --workingdir=$wd --threads 8 --AUGUSTUS_SCRIPTS_PATH=/home/katharina/git/Augustus/scripts/ ) &> test1.log
